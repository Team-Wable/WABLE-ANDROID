...
import com.teamwable.ui.util.TransparentRange.Companion.HEX_COLOR_PATTERN
...
enum class TransparentRange(val range: IntRange, val clampedValue: Int) {
    ...
    RANGE_8(-20..-11, -20),
    RANGE_9(-10..-1, -10),
    RANGE_10(0..Int.MAX_VALUE, 0),
    ;

    companion object {
        fun getTransparentRange(value: Int) = entries.firstOrNull { value in it.range } ?: RANGE_10
